...
function init(self) {
  ...
  if (self.s.readPreference) {
    findByIdOptions.readPreference = self.s.readPreference;
  }
  if (self.s.options && self.s.options.sort) {
    findByIdOptions.sort = self.s.options.sort;
  }
  if (self.s.options && self.s.options.skip) {
    findByIdOptions.skip = self.s.options.skip;
  }

  self.s.files.findById(self.s.filter, findByIdOptions, function(error, doc) {
    if (error) {
