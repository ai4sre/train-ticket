...
Collection.prototype.findById = function() {
  ...
  // Execute using callback
  if(typeof callback == 'function') return findById(self, args, callback);

  // Return a Promise
  return new this.s.promiseLibrary(function(resolve, reject) {
    findById(self, args, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    });
  });
...
var findById = function(self, args, callback) {
...
define.classMethod('findById', {callback: true, promise:true});
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Collection.prototype.findByIdAndDelete = function(filter, options, callback) {
  var self = this;
  if(typeof options == 'function') callback = options, options = {};
  options = options || {};
  ...
  // Execute using callback
  if(typeof callback == 'function') return findByIdAndDelete(self, filter, options, callback);

  // Return a Promise
  return new this.s.promiseLibrary(function(resolve, reject) {
    options = options || {};

    findByIdAndDelete(self, filter, options, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    });
  });
...
var findByIdAndDelete = function(self, filter, options, callback) {
  // Final options
...
define.classMethod('findByIdAndDelete', {callback: true, promise:true});
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Collection.prototype.findByIdAndReplace = function(filter, replacement, options, callback) {
  var self = this;
  if(typeof options == 'function') callback = options, options = {};
  options = options || {};
  ...
  // Execute using callback
  if(typeof callback == 'function') return findByIdAndReplace(self, filter, replacement, options, callback);

  // Return a Promise
  return new this.s.promiseLibrary(function(resolve, reject) {
    options = options || {};

    findByIdAndReplace(self, filter, replacement, options, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    });
  });
...
var findByIdAndReplace = function(self, filter, replacement, options, callback) {
  // Final options
  var finalOptions = shallowClone(options);
  finalOptions['fields'] = options.projection;
...
define.classMethod('findByIdAndReplace', {callback: true, promise:true});
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Collection.prototype.findByIdAndUpdate = function(filter, update, options, callback) {
  var self = this;
  if(typeof options == 'function') callback = options, options = {};
  options = options || {};
  ...
  // Execute using callback
  if(typeof callback == 'function') return findByIdAndUpdate(self, filter, update, options, callback);

  // Return a Promise
  return new this.s.promiseLibrary(function(resolve, reject) {
    options = options || {};

    findByIdAndUpdate(self, filter, update, options, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    });
  });
...
var findByIdAndUpdate = function(self, filter, update, options, callback) {
  // Final options
  var finalOptions = shallowClone(options);
  finalOptions['fields'] = options.projection;
  finalOptions['update'] = true;
...
define.classMethod('findByIdAndUpdate', {callback: true, promise:true});
 ...
 * @return {Promise} returns Promise if no callback passed
 * @deprecated use findByIdAndUpdate, findByIdAndReplace or findByIdAndDelete instead
 */
