...
var _open = function(self, options, callback) {
  ...
  // Fetch the chunks
  if(query != null) {
    collection.findById(query, options, function(err, doc) {
...
var nthChunk = function(self, chunkNumber, options, callback) {
  ...
  options.readPreference = self.readPreference;
  // Get the nth chunk
  self.chunkCollection().findById({'files_id':self.fileId, 'n':chunkNumber}, options, function(err, chunk) {
    if(err) return callback(err);
...
var exists = function(db, fileIdObject, rootCollection, options, callback) {
  ...
  db.collection(rootCollectionFinal + ".files", function(err, collection) {
    ...
    collection.findById(query, {readPreference:readPreference}, function(err, item) {
      if(err) return callback(err);
