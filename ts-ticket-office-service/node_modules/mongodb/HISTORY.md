...
* NODE-962 Merge in ignoreUndefined from collection level for find/findById.
...
* MongoDB 3.4-RC Pass collation options on update, findById, find, createIndex, aggregate.
...
* Use findById instead of find followed by nextObject (Issue #1216, https://github.com/sergeyksv)
...
-----------------------
* CRUD API (insertOne, insertMany, updateOne, updateMany, removeOne, removeMany, bulkWrite, findByIdAndDelete, findByIdAndUpdate, findByIdAndReplace)
...
* Modified findById to use nextObject instead of toArray avoiding a nextTick operation (Issue #836)
...
0.9.8-7 2012-02-06
------------------
* Simplified findById to use the find command instead of the custom code (Issue #498).
...
* Added support for $returnKey, $maxScan, $min, $max, $showDiskLoc, $comment to cursor and find/findById methods.
...
* Allows raw (no bson parser mode for insert, update, remove, find and findById)
...
* Fixed error handling bug in findById
...
* Fixed slaveOk bug for findById method
