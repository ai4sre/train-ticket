...
public class FoodMapServiceImplTest {
    ...
    public void testCreateFoodStore1() {
        ...
        Mockito.when(foodStoreRepository.findOne(Mockito.any(UUID.class))).thenReturn(fs);
    ...
    public void testCreateFoodStore2() {
        FoodStore fs = new FoodStore();
        Mockito.when(foodStoreRepository.findOne(Mockito.any(UUID.class))).thenReturn(null);
    ...
    public void testCreateTrainFood1() {
        ...
        Mockito.when(trainFoodRepository.findOne(Mockito.any(UUID.class))).thenReturn(tf);
    ...
    public void testCreateTrainFood2() {
        TrainFood tf = new TrainFood();
        Mockito.when(trainFoodRepository.findOne(Mockito.any(UUID.class))).thenReturn(null);
